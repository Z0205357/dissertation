...
flow_path = BASE_DIR / "24011_flow_cleaned.parquet"
out_path = BASE_DIR / "24011_Flow–Concentration Merging.parquet"

# ========= 2. Load data =========
metal_df = pd.read_parquet(metal_path)
flow_df = pd.read_parquet(flow_path)

# ========= 3. Standardise dates for alignment =========
...
# ========= 4. Merge metal concentration and flow data =========
